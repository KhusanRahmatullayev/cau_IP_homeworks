# -*- coding: utf-8 -*-
"""Filters_Segmentations_PSNR_SSIM.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IlyJZYFdXeg5bknioPhAUk-eTPDYcyhl
"""
...
class Filters:
    ...
    def call_filters(self, flag: int, window_size: int, noise_image):
...
image2 = cv2.imread('/content/drive/MyDrive/Noisy images/Gaussian/G50C.png')
...
class Segmentations:
    ...
    def eight_compass_filter(self):
        compass_kernels = [
                np.array([[-1, -1, -1], [-1, 8, -1], [-1, -1, -1]]), # N
                np.array([[-1, -1, -1], [1, 1, 1], [1, 1, 1]]),      # NE
                np.array([[-1, -1, 2], [-1, 2, -1], [2, -1, -1]]),   # E
                np.array([[1, 1, 1], [-1, -1, -1], [-1, -1, -1]]),   # SE
                np.array([[2, -1, -1], [-1, 2, -1], [-1, -1, 2]]),   # S
                np.array([[-1, -1, -1], [-1, -1, -1], [1, 1, 1]]),   # SW
                np.array([[-1, 2, -1], [2, -1, 2], [-1, 2, -1]]),    # W
                np.array([[1, 1, 1], [1, 1, 1], [-1, -1, -1]])       # NW
            ]
...
image = cv2.imread("/content/drive/MyDrive/Noisy images/Gaussian/G50C.png")
image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
segmentations = Segmentations(None, None, None, None)

# task = segmentations.call_segmentation(1, 0, image, 100)
# printi(task)
task = segmentations.call_segmentation(1, 1, image, 100)
